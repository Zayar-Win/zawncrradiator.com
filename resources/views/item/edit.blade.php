            ...
            <div class="col-md-6">
                    ...
                    <form action="{{url ('item/'.$item->id) }}" method="POST" enctype="multipart/form-data" >
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="t_pic" class="form-control" value="{{ $item->t_pic ?? old('t_pic')}}"
                             required >
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="cnc_quantity" class="form-control"  value="{{ $item->cnc_quantity ?? old('cnc_quantity')}}"
                             required >
                        </div>
                        <div class="form-group">
                            <label for="nagoya_quantity"  class="mb-2 mt-2">Nagoya Quantity</label>
                            <input type="number" name="nagoya_quantity" class="form-control"  value="{{ $item->nagoya_quantity ?? old('nagoya_quantity')}}"
                             required >
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="t_pic_price" class="form-control" value="{{ $item->t_pic_price ?? old('t_pic_price')}}"
                             required >
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="t_pic_mm" class="form-control" value="{{ $item->t_pic_mm ?? old('t_pic_mm')}}"
                             required >
                        </div>
                        <div class="form-group">
