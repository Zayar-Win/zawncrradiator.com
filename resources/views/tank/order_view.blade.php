        ...
        <div class="row">
            ...
            <div class="col-md-11">
                ...
                <div class="col-md-5 mb-3">
                        ...
                        <div class="col-md-5 mb-3">
                        <select  class="form-select" aria-label="Default select example" name="type" id="t_type">
        ...
        <tr>
            ...
            <td>{{$order->item}}</td>
                         ...
                         <div class="table-footer pb-2" id="card-footer">
                             <div class="float-end">
                         <a href="{{url('/tank_order/'.$order->id.'/print')}}" style="text-decoration:none;" class="float-end">
                          <button class="btn  btn-sm text-white "  style="background: rgb(95, 44, 130);"  > <i class="fa fa-print"></i> Create Print</button>
                                </a>
                             </div>
                             @if(Auth::user()->status=='admin')
                                <div>
                                <form action="{{ url('tank_order/'.$order->id) }}" method="POST">
                                @method('DELETE')
                                @csrf
                                <td>
