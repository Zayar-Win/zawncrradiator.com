            ...
            <div class="col-md-7" >
                ...
                <div class="card" id="hahah">
                    ...
                    <div class="card-body">
                        ...
                        <div class="float-end">
                        <form action="{{ url('foreign_joka_view/'.$item->id.'/destroy') }}" method="POST">
                            @method('DELETE')
                            @csrf
                            <td>
                        ...
                        <div class="float-start">
                            ...
                            <a href="{{url('foreign_joka_view/'.$item->id.'/edit')}}" style="text-decoration: none;">
