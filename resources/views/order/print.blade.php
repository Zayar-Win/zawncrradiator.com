...
<tr>
    ...
    <td><h6>Total</h6></td>
    <td><h6>{{number_format($order_receipt->sum('amount'),2)}}</h6> </td>
</tr>
                    </table>
                </div>
                <h6 class="float-end my-4 mx-5" > Signature </h6>
                  ...
                  onclick="printContent('print_card')"  > <i class="fa fa-print"></i></button> --}}
                  <button class="btn btn-sm btn-dark float-end my-4 mx-4 " id="print"
...
//     var div= $('#print_card').html();
//     var printwindow = window.open('','','height=700 ,width=1500,margin-top=50,margin-left=100');
//     printwindow.document.write('<html><head><title>NCR </title>');
